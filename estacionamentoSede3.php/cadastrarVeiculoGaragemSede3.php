...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $localizacao = 'GARAGEM SEDE III'; // Definir a localização diretamente
    ...
    if (empty($nome) && ($tipo == 'PARTICULAR' || $tipo == 'MOTO')) {
        ...
        header("Location: cadastrarVeiculoGaragemSede3.PHP");
        exit();
    }
...
$veiculos = $pdo->query("SELECT * FROM veiculos WHERE localizacao = 'GARAGEM SEDE III'")->fetchAll();

// Buscar os acessos liberados para exibir no formulário
$acessos_query = $pdo->query("SELECT id, nome FROM acessos_liberados WHERE localizacao = 'GARAGEM SEDE III'");
...
<div class="container">
    <h4 class="text-center mt-5">Cadastrar Veículo - Garagem Sede III</h4>
    ...
    <!-- Formulário de cadastro -->
    <form action="cadastrarVeiculoGaragemSede3.php" method="POST">
        <div class="row">
            <div class="col-md-3">

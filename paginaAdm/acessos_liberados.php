...
// Adicionar novo acesso liberado
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'add') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO acessos_liberados (nome, matricula, localizacao, usuario_cadastro) VALUES (:nome, :matricula, :localizacao, :usuario_cadastro)");
        $stmt->bindParam(':nome', $nome);
        $stmt->bindParam(':matricula', $matricula);
        $stmt->bindParam(':localizacao', $localizacao);
        $stmt->bindParam(':usuario_cadastro', $usuario_cadastro);
        $stmt->execute();
        $msg = "Acesso liberado cadastrado com sucesso!";
...
if (isset($_GET['delete'])) {
    ...
    try {
        ...
        header("Location: acessos_liberados.php?success=deleted");
        exit;
    } catch (PDOException $e) {
...
<body>
    ...
    <div class="container">
        <h1 class="mt-5 text-center">Acessos Liberados</h1>
        ...
        <!-- Campo de busca -->
        <form action="acessos_liberados.php" method="GET" class="d-flex mb-4">
            ...
            <a href="acessos_liberados.php" class="btn btn-secondary me-2">Limpar</a>
        ...
        <!-- Formulário de Cadastro de Acesso Liberado -->
        <form action="acessos_liberados.php" method="POST" class="mt-4">
                ...
                <?php foreach ($acessos as $acesso) { ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="acessos_liberados.php?delete=<?= $acesso['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Tem certeza que deseja excluir?')">Excluir</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
    ...
    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="acessos_liberados.php" method="POST">
                    <input type="hidden" name="action" value="edit">
                    <input type="hidden" name="id" id="editId">
                    <div class="modal-header">
                        <h5 class="modal-title" id="editModalLabel">Editar Acesso Liberado</h5>

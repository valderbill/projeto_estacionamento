...
// Buscar acessos liberados para Garagem Sede III
$stmt = $pdo->prepare("SELECT id, nome, matricula FROM acessos_liberados WHERE localizacao = 'Garagem Sede III' ORDER BY nome ASC");
$stmt->execute();
...
<body>
  ...
  <ul class="nav nav-tabs justify-content-center mt-3">
    ...
    <div class="container">
        <h5 class="mt-5 text-center">Acessos Liberados - Garagem Sede III</h5>

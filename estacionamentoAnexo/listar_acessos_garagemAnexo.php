...
// Buscar acessos liberados para Garagem Anexo
$stmt = $pdo->prepare("SELECT id, nome, matricula FROM acessos_liberados WHERE localizacao = 'Garagem Anexo' ORDER BY nome ASC");
$stmt->execute();
...
<body>
    ...
    <div class="container">
        <h5 class="mt-5 text-center">Acessos Liberados - Garagem Anexo</h5>

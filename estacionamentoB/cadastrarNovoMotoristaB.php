...
<body>
    ...
    <div class="container">
        <h4 class="mt-5 text-center">Cadastrar Novo Motorista - Estacionamento B</h4>
        ...
        <form action="cadastrarNovoMotoristaB.php" method="POST" class="mt-4">

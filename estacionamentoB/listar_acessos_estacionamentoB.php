...
// Buscar acessos liberados Estacionamento B
$stmt = $pdo->prepare("SELECT id, nome, matricula FROM acessos_liberados WHERE localizacao = 'ESTACIONAMENTO B' ORDER BY nome ASC");
$stmt->execute();
...
<body>
    ...
    <div class="container">
        <h5 class="mt-5 text-center">Acessos Liberados - ESTACIONAMENTO B</h5>

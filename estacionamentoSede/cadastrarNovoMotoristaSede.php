...
<body>
    ...
    <div class="container">
        <h4 class="mt-5 text-center">Cadastrar Novo Motorista - Garagem Sede</h4>
        ...
        <form action="cadastrarNovoMotoristaSede.php" method="POST" class="mt-4">
            ...
            <div class="mb-3" id="localizacao-group" style="display: none;">
                ...
                <select class="form-control" id="localizacao" name="localizacao">
                    <option value="Garagem Sede">Garagem Sede</option>
                </select>
            </div>

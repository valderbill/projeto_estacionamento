...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $localizacao = 'GARAGEM SEDE'; // Definir a localização diretamente
    ...
    if (empty($nome) && ($tipo == 'PARTICULAR' || $tipo == 'MOTO')) {
        ...
        header("Location: cadastrarVeiculoGaragemSede.php");
        exit();
    }
...
$veiculos = $pdo->query("SELECT * FROM veiculos WHERE localizacao = 'GARAGEM SEDE'")->fetchAll();

// Buscar os acessos liberados para exibir no formulário
$acessos_query = $pdo->query("SELECT id, nome FROM acessos_liberados WHERE localizacao = 'GARAGEM SEDE'");
...
<div class="container">
    <h4 class="text-center mt-5">Cadastrar Veículo - Garagem Sede</h4>
    ...
    <!-- Formulário de cadastro -->
    <form action="cadastrarVeiculoGaragemSede.php" method="POST">
        <div class="row">
            <div class="col-md-3">

...
// Buscar acessos liberados Estacionamento C
$stmt = $pdo->prepare("SELECT id, nome, matricula FROM acessos_liberados WHERE localizacao = 'ESTACIONAMENTO C' ORDER BY nome ASC");
$stmt->execute();
...
<body>
    ...
    <div class="container">
        <h4 class="mt-5 text-center">Acessos Liberados - ESTACIONAMENTO C</h4>

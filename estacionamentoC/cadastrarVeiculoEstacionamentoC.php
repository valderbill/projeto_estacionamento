...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $localizacao = 'ESTACIONAMENTO C'; // Definir a localização diretamente
    ...
    if (empty($nome) && ($tipo == 'PARTICULAR' || $tipo == 'MOTO')) {
        ...
        header("Location: cadastrarVeiculoEstacionamentoC.php");
        exit();
    }
...
$veiculos = $pdo->query("SELECT * FROM veiculos WHERE localizacao = 'ESTACIONAMENTO C'")->fetchAll();

// Buscar os acessos liberados para exibir no formulário
$acessos_query = $pdo->query("SELECT id, nome FROM acessos_liberados WHERE localizacao = 'ESTACIONAMENTO C'");
...
<div class="container">
    <h4 class="text-center mt-5">Cadastrar Veículo - ESTACIONAMENTO C</h4>
    ...
    <!-- Formulário de cadastro -->
    <form action="cadastrarVeiculoEstacionamentoC.php" method="POST">
        <div class="row">
            <div class="col-md-3">
